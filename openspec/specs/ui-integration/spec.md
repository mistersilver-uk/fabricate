...
The recipe editor's Tools tab authors required Tools at recipe and step scope and preserves any persisted ingredient-set Tool references it does not expose.
