...
7. **THE EXPORT-PAYLOAD UPCAST RUNS THE SAME PER-SYSTEM TRANSFORM**, over the bundle's one system with its own recipes and gathering slice, ordered AFTER the `1.28.0` character-libraries lift so the catalogue the intersection needs is known.
