...
A save RETURNS the record as persisted rather than as submitted, so a caller that re-sends what it was handed cannot re-introduce an id the write pruned.
