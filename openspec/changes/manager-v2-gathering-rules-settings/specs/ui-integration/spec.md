...
#### Scenario: Settings tab shows context without duplicate evidence
- **WHEN** a GM opens Manager V2 Gathering and selects Settings
- **THEN** the main panel shows Settings-specific header copy
- **AND** the main panel does not duplicate the selected system's reward, hazard, and hazard outcome values
...
- **AND** Rewards, Hazards, and Hazard Outcome descriptions are localized beside their icons
- **AND** each rule select appears underneath its description without bold select text
