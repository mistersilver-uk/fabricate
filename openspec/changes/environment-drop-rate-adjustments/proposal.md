...
- Add task-level and hazard-level apply toggles for environment-local drop-rate adjustments so GMs can preserve configured values while disabling their runtime effect.
