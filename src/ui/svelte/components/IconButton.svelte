...
<!--
  ...
  `.manager-button` (`:13540-13541`), its own 34px box (`:13755`), the 28px box the
  pager gives it (`:13792`) and its own focus pair, the `:focus` strip at `:13766` and
  the `:focus-visible` repaint at `:13779` — and a scoped block here would be a second
