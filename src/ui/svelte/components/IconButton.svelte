...
<!--
  ...
  `.manager-button` (`:13559-13560`), its own 34px box (`:13774`), the 28px box the
  pager gives it (`:13811`) and its own focus pair, the `:focus` strip at `:13785` and
  the `:focus-visible` repaint at `:13798` — and a scoped block here would be a second
