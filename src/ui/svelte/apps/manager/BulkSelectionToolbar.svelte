<!--
  ...
  | `rowClass` and the five `*Attr` hook names | string | the Component Studio's | the host toolbar row class this root joins, and the five test and screenshot hooks — PARAMETERS of this primitive, not a reason to fork it (`openspec/specs/ui-integration/spec.md`, Selection controls) |
