...
<section class="manager-inspector-card">
  ...
  <div class="manager-fact-grid manager-environment-runtime-grid">
    ...
    <div class="manager-fact" data-runtime-fact="available-events"><span class="manager-fact-line"><strong>{counts.availableEvents || 0}</strong> <span class="manager-fact-label">{text('FABRICATE.Admin.Manager.EnvironmentEditor.Inspector.AvailableEvents', 'Available events')}</span></span></div>
    <div class="manager-fact" data-runtime-fact="excluded-events"><span class="manager-fact-line"><strong>{counts.excludedEvents || 0}</strong> <span class="manager-fact-label">{text('FABRICATE.Admin.Manager.EnvironmentEditor.Overview.ExcludedEvents', 'Excluded events')}</span></span></div>
    <div class="manager-fact" data-runtime-fact="unavailable-included"><span class="manager-fact-line"><strong>{(counts.unavailableTasks || 0) + (counts.unavailableEvents || 0)}</strong> <span class="manager-fact-label">{text('FABRICATE.Admin.Manager.EnvironmentEditor.Overview.UnavailableIncluded', 'Included but unavailable')}</span></span></div>
  </div>
</section>
