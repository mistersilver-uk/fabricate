...
<script>
  ...
  // The card kept its collapse affordance from the Settings tab, but here it is the whole page,
  // so it starts expanded and the state is local rather than shared with other sections.
  let currencyCollapsed = $state(false);
  function toggleCurrencyCollapsed() {
  ...
  >
    <header class="manager-character-modifier-card-header">
      <button
        ...
        onclick={toggleCurrencyCollapsed}
      >
        <i
                  ...
                  <div class="manager-currency-provider-managed-summary">
                    ...
                    <div class="manager-currency-readonly-fields">
                      ...
                      <div class="manager-currency-readonly-field">
                        ...
                        <span
                          class="manager-currency-readonly-value"
                          data-world-currency-abbreviation>{unit.abbreviation || '—'}</span
                        >
                      </div>
                      <div class="manager-currency-readonly-field">
                        <span class="manager-currency-readonly-label"
                        ...
                        <span
                          class="manager-currency-readonly-value"
                          data-world-currency-denomination>{unit.denomination || unit.id}</span
                        >
                      </div>
                    </div>
                  </div>
                        ...
                        {#if (unit.contains || []).length > 0}
                          ...
                          >
                            {#each unit.contains as contained (contained.unitId)}
                              ...
                              >
                                <i class={currencyUnitIcon(contained.unitId)} aria-hidden="true"
                                ></i>
