<!-- Svelte 5 runes mode -->
<!--
  The world Essence Catalogue (issue 1362). PR 6b replaces this body.
...
<ScopedPlaceholderPage
  ...
  titleKey="FABRICATE.Admin.Manager.Scoped.EssenceCatalogueTitle"
  titleFallback="Essence Catalogue"
/>
