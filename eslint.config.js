...
/**
 * The DOMAIN LAYER's roots (issue 1677) — Architecture Pointers' list of where domain and runtime
 * logic lives, minus `src/integrations/`, which is on that list and is an edge by definition.
 *
