...
That baseline only shrinks, and its length is capped, so recording a new script as debt instead of gating it means raising a number in review rather than appending a line.
