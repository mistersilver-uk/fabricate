...
A change to the lab's own fixture world, mount page, capture driver or registry selects **surface coverage** by design — one frame of every route and tab the lab renders, 35 of 248 cases — not every publishable case, because the detailed states of a screen are captured by the files that draw them, not by a shared input.
