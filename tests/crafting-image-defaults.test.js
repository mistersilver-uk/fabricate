...
// The Crafting tab keeps a standalone copy of the default recipe image so its Svelte component tree
// does not import the whole models/Recipe.js graph just to resolve a fallback path.
