...
test('the runner applies 1.18.0 and bumps the migration version', async () => {
  ...
  // Lands at the current highest (1.20.0, the recipe-modifier authority split runs after
  // 1.19.0 in the same pass); it is a no-op on this fixture, so the strip still holds.
