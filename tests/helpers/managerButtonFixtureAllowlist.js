...
export const FIXTURE_ALLOWLIST = Object.freeze([
  ...
  Object.freeze({
    ...
    count: 1,
    why:
      'The IDLE half of `ArmedDangerButton` (`ArmedDangerButton.svelte` writes this string, now ' +
      'behind the family root), held out of the conversion. The dock-pinning suite renders it as ' +
