...
test('DOMAIN.md is the corpus these assertions think it is', () => {
  ...
  // forever. 229 rows across four tables; the newest covers salvage's own Phantom Run.
  ...
  assert.equal(TABLE_ROWS.length, 229, 'the DOMAIN.md table corpus changed size');
