...
test('DOMAIN.md is the corpus these assertions think it is', () => {
  ...
  // forever. 226 rows across four tables; the newest name the craft pipeline's reserved verbs and flag.
  ...
  assert.equal(TABLE_ROWS.length, 226, 'the DOMAIN.md table corpus changed size');
