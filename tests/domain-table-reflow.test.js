...
test('DOMAIN.md is the corpus these assertions think it is', () => {
  ...
  // forever. 228 rows across four tables; the newest cover ingredient display state and the no-image sentinel.
  ...
  assert.equal(TABLE_ROWS.length, 228, 'the DOMAIN.md table corpus changed size');
