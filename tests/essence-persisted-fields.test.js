/**
 * Issue 1036 — `EssenceDefinition.enabled` and `EssenceDefinition.propertyMacroUuid` persistence,
 * and the authored component quantities a disable must never destroy.
 */
...
test('1371 r20: the editor round-trip CARRIES a quantity whose essence this system does not define', () => {
  // THIS ASSERTION WAS INVERTED AT r20-store3 (reviewer round 6, finding 2).
  const manager = makeManager();
