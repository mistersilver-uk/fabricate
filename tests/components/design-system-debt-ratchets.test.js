...
test("the module sheet's cross-list selector repetition does not move", () => {
  // FILTERED TO count >= 2 ON BOTH SIDES. Unfiltered the sheet holds 3,100 `(at-context, selector)`
  // keys under this very keying, of which 2,981 appear exactly once; `assertRatchet` compares key
