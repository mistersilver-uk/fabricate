...
test("the module sheet's cross-list selector repetition does not move", () => {
  // Filtered to count >= 2 on both sides. Unfiltered the sheet holds 3,079 `(at-context, selector)`
  // keys under this very keying, of which 2,972 appear exactly once; `assertRatchet` compares key
