 ...
 * Unfiltered, the sheet holds 3,044 `(at-context, selector)` keys, of which 2,932 appear exactly
 ...
 * MEASURED after #1648's parity correction adds the shared summary header and compact
 * history dismissal rules, by `the sheet's cross-list selector repetition
