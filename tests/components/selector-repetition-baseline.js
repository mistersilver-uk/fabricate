 ...
 * Unfiltered, the sheet holds 3,058 `(at-context, selector)` keys, of which 2,946 appear exactly
 ...
 * MEASURED after #1648's compact pager and dense ListRow add thirteen rules and fourteen
 * singleton selector keys, by `the sheet's cross-list selector repetition
 ...
 * printed from. The sheet holds 2,574 rules at that head, 112 repeated keys and 229 appearances
