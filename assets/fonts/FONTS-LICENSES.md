...
| Family | Files | License | License text |
| --- | --- | --- | --- |
| Spectral | `spectral-latin-*-normal.woff2` | SIL Open Font License 1.1 | `OFL-Spectral.txt` |
| JetBrains Mono | `jetbrains-mono-latin-*-normal.woff2` | SIL Open Font License 1.1 | `OFL-JetBrainsMono.txt` |
| Signika | `signika-latin-*-normal.woff2` | SIL Open Font License 1.1 | `OFL-Signika.txt` |
| Font Awesome 6 Free | `fontawesome/webfonts/fa-*.woff2` | SIL OFL 1.1 (fonts); CC BY 4.0 (icons); MIT (code) | `fontawesome/LICENSE.txt` |
