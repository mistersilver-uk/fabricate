...
export async function runSmokeCleanup(ctx) {
  const {
    page, browser, results, profile, resultsDir, consoleErrors, waivedConsoleErrors, consoleLog,
    phaseTimings, viewTimings, screenshotManifestEntries, startPhase, endPhase
  } = ctx;
