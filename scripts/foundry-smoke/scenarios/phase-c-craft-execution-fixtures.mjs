...
export async function seedSmokeCraftExecutionFixtures(page, craftingSetup, crafterId) {
  return await page.evaluate(
    async ({ arcaneSystemId, mysticHerbComponentId, crafterId }) => {
      ...
      const worldSpecs = [
        ...
        {
          name: 'Smoke Kiln-Fired Ceramic Roofing Tile',
      ...
      const simpleSystem = await csm.createSystem({
        ...
        description:
          'Issue #489: simple-mode crafts, tool breakage, and salvage execution coverage.',
      });
          ...
          resultGroups: [
            {
              ...
              results: [
                {
                  id: 'smoke-air-simple-shard',
                  componentId: simpleMap['Smoke Shard'],
                  quantity: 1,
                },
              ],
            },
          ...
          resultGroups: [
            {
              ...
              name: 'Salvaged Parts',
              results: [
                { id: 'smoke-shard-result', componentId: simpleMap['Smoke Shard'], quantity: 2 },
              ],
            },
          ],
        },
          ...
          resultGroups: [
            {
              ...
              results: [
                { id: 'smoke-toolchest-shard', componentId: simpleMap['Smoke Shard'], quantity: 1 },
              ],
            },
          ],
        },
            ...
            ingredientGroups: [
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: simpleMap['Smoke Plank'] },
                  },
                ],
              },
            ],
      ...
      const breakageRecipe = await rm.createRecipe({
        ...
        resultGroups: [
          { name: 'Toy', results: [{ componentId: simpleMap['Smoke Toy'], quantity: 1 }] },
        ],
      });
      ...
      const limitedUsesRecipe = await rm.createRecipe({
        ...
        resultGroups: [
          { name: 'Dowel', results: [{ componentId: simpleMap['Smoke Dowel'], quantity: 1 }] },
        ],
      });
      ...
      const negativeToolRecipe = await rm.createRecipe({
        ...
        description:
          'Simple-mode craft requiring a tool the crafter does not hold (negative gating).',
        craftingSystemId: simpleSystemId,
        ...
        resultGroups: [
          { name: 'Bracket', results: [{ componentId: simpleMap['Smoke Bracket'], quantity: 1 }] },
        ],
      });
      ...
      const multiOptionRecipe = await rm.createRecipe({
        ...
        description:
          'Simple-mode craft with one component-or-essence ingredient choice (issue #552).',
        craftingSystemId: simpleSystemId,
            ...
            ingredientGroups: [
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: simpleMap['Smoke Copper Coil'] },
                  },
                  {
                    quantity: 1,
                    match: { type: 'essence', essenceId: 'smoke-star-essence', amount: 2 },
                  },
                ],
              },
            ],
      ...
      await rm.createRecipe({
        ...
        resultGroups: [
          { name: 'Seal', results: [{ componentId: simpleMap['Smoke Filigree'], quantity: 1 }] },
        ],
      });
      ...
      await rm.createRecipe({
            ...
            ingredientGroups: [
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'essence', essenceId: 'smoke-star-essence', amount: 6 },
                  },
                ],
              },
            ],
        ...
        resultGroups: [
          { name: 'Draught', results: [{ componentId: simpleMap['Smoke Toy'], quantity: 1 }] },
        ],
      });
      ...
      await rm.createRecipe({
        ...
        description:
          'Requirement rail: a met fixed slot, an unchosen choice slot, and a short essence slot.',
        craftingSystemId: simpleSystemId,
            ...
            ingredientGroups: [
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: simpleMap['Smoke Runeplate'] },
                  },
                ],
              },
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: simpleMap['Smoke Anvil'] },
                  },
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: simpleMap['Smoke Bracket'] },
                  },
                ],
              },
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'essence', essenceId: 'smoke-ember-essence', amount: 4 },
                  },
                ],
              },
            ],
      ...
      await rm.createRecipe({
        ...
        description:
          'Shared essence pool: two requirements in one set funded jointly from dual carriers.',
        craftingSystemId: simpleSystemId,
        img: 'icons/magic/water/barrier-ice-crystal-wall-faceted-blue.webp',
        ingredientSets: [
          {
            ...
            ingredientGroups: [
              ...
              },
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'essence', essenceId: 'smoke-tide-essence', amount: 3 },
                  },
                ],
              },
              {
      ...
      await rm.createRecipe({
        ...
        description:
          'Tag requirement with nothing matching in inventory: the tile must render a glyph, not the item bag.',
        craftingSystemId: simpleSystemId,
            ...
            ingredientGroups: [
              ...
              },
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'tags', tags: ['smoke-voidbound'], tagMatch: 'any' },
                  },
                ],
              },
            ],
        ...
        resultGroups: [
          { name: 'Sigil', results: [{ componentId: simpleMap['Smoke Filigree'], quantity: 1 }] },
        ],
      });
      ...
      await rm.createRecipe({
        ...
        steps: [
          ...
          },
          {
                ...
                ingredientGroups: [
                  {
                    ...
                    options: [
                      {
                        quantity: 1,
                        match: { type: 'component', componentId: simpleMap['Smoke Dowel'] },
                      },
                    ],
                  },
                ],
            ...
            resultGroups: [
              { name: 'Crate', results: [{ componentId: simpleMap['Smoke Crate'], quantity: 1 }] },
            ],
          },
        ],
      });
            ...
            ingredientGroups: [
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: routerMap['Smoke Ingot A'] },
                  },
                ],
              },
            ],
            ...
            ingredientGroups: [
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: routerMap['Smoke Ingot B'] },
                  },
                ],
              },
            ],
        ...
        resultGroups: [
          {
            id: ringGroupId,
            name: 'Ring',
            results: [{ componentId: routerMap['Smoke Ring'], quantity: 1 }],
          },
          {
            id: amuletGroupId,
            name: 'Amulet',
            results: [{ componentId: routerMap['Smoke Amulet'], quantity: 1 }],
          },
        ],
      });
      ...
      const checkMap = await registerComponents(checkRouterSystemId, [
        'Smoke Bar',
        'Smoke Masterwork Blade',
        'Smoke Standard Blade',
      ]);
            ...
            ingredientGroups: [
              {
                name: 'Bar',
                options: [
                  { quantity: 1, match: { type: 'component', componentId: checkMap['Smoke Bar'] } },
                ],
              },
            ],
          },
          ...
          resultGroups: [
            {
              ...
              results: [
                {
                  id: 'smoke-salvage-brick',
                  componentId: progressiveMap['Smoke Brick'],
                  quantity: 1,
                },
                {
            ...
            ingredientGroups: [
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: progressiveMap['Smoke Clay'] },
                  },
                ],
              },
            ],
      ...
      const rcGatherEnvironment = await environmentStore.create({
        ...
        description:
          'Scene-less guaranteed-success environment for the rc/ci gather-delta assertion.',
      ...
      const hazardEnvironment = await environmentStore.create({
        ...
        description:
          'Scene-less environment that composes the hazardous Bramble Snare event for #489.',
      ...
      return {
        ...
        executionRecipeIds: [
          simpleRecipe.id,
          breakageRecipe.id,
          limitedUsesRecipe.id,
          negativeToolRecipe.id,
          multiOptionRecipe.id,
          ingredientRoutedRecipe.id,
          checkRoutedRecipe.id,
          progressiveRecipe.id,
        ],
        simple: {
        ...
        progressive: {
          recipeId: progressiveRecipe.id,
          systemId: progressiveSystemId,
          recipeName: 'Smoke Mold Brick',
        },
