  ...
  return await page.evaluate(
    async ({ crafterId }) => {
            ...
            ingredientGroups: [
              {
                ...
                options: [
                  {
                    quantity: 2,
                    match: { type: 'component', componentId: cauldronMap['Mystic Herb'] },
                  },
                ],
              },
            ],
            ...
            ingredientGroups: [
              ...
              },
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: cauldronMap['Empty Vial'] },
                  },
                ],
              },
            ],
      ...
      const herbalist = await csm.createSystem({
        ...
        description:
          'Issue #543: a second alchemy discipline so the workbench chooser offers a choice.',
      });
            ...
            ingredientGroups: [
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: herbalistMap['Powdered Root'] },
                  },
                ],
              },
            ],
      ...
      const bench = await csm.createSystem({
        ...
        description:
          'Issue #752: minimal alchemy-mode system for the manager alchemy-settings capture.',
      });
      ...
      const benchMap = {
        'Smoke Bench Reagent': await registerComponent(
          benchId,
          productByName['Smoke Bench Reagent']
        ),
            ...
            ingredientGroups: [
              {
                ...
                options: [
                  {
                    quantity: 1,
                    match: { type: 'component', componentId: benchMap['Smoke Bench Reagent'] },
                  },
                ],
              },
            ],
      ...
      return {
        ...
        alchemyComponentMap: {
          [cauldronId]: cauldronMap,
          [herbalistId]: herbalistMap,
          [benchId]: benchMap,
        },
      };
    },
