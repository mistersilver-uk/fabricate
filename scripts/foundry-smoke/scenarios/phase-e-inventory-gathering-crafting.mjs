...
import { assertNoScreenshotOverlays, assertPointerTarget, closeOpenApplications, describeBlockingOverlay } from '../pageOps/pageLifecycle.mjs';
import { assertProgressiveStageListSound, handleRollPromptIfPresent } from '../pageOps/managerViews.mjs';
