...
import { TRANSIENT_TEARDOWN_SKIP_PREFIX, shouldTolerateSmokeTeardown } from '../../lib/foundrySmokeSignal.js';
import { activateSceneAndAwaitCanvasReady, assertNoScreenshotOverlays, closeOpenApplications, exerciseManagerPointerTargets, exerciseManagerSystemEditPointerTargets, managerSystemRowSelector, selectSmokeSystemInManager, setManagerWindowSize, settleManagerNav } from '../pageOps/pageLifecycle.mjs';
import { assertManagerLayoutStable, captureManagerThemes, chooseSelectOption, returnToSystemLibrary } from '../pageOps/managerViews.mjs';
import {
...
export default {
  ...
  phase: null,
  section: null,
  children: [d0Recipes, d0ComponentsChecks, d0TagsEssences, d0Gathering, d0Tools, d0WorldScopeIdentity, d0Knowledge, d0OverviewInteractables, d0ImportAlchemyExperimental],
