 ...
 */
export async function captureStableManagerView(ctx, { width, height, layout, label, settleMs = 0 }) {
  const { page, screenshot } = ctx;
 ...
 * 651).
 */
export async function assertProgressiveStageListSound(page, label, { expectAnnouncement = false } = {}) {
  const report = await withDeadline(page.evaluate(() => {
