...
| [0002 — Fabricate Premium companion architecture]({% link adr/0002-fabricate-premium-companion-architecture.md %}) | Not yet taken — awaiting maintainer selection | How the free module and a paid companion are built, licensed, coupled, distributed and verified |
