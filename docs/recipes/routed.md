...
It is authored on the **The roll** section of **Checks › Crafting** with the same pass or fail editor Simple mode uses: a roll formula, a DC, a meet or exceed comparison, a static or dynamic difficulty, and per-recipe check tiers.
...
Re-author the DC on the **The roll** section of **Checks › Crafting** after switching into Routed by check so the tier check uses the difficulty you intend.
