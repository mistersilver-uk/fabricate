...
When the system has a check-modifier catalogue and its authority level grants recipes a say, the Overview tab also lets a recipe override which modifiers are eligible and, at the highest authority level, how they combine.
