...
{: .note }
> **Access** appears in the **Crafting** menu only while the system's visibility mode is **Restricted**.
> See [Settings]({% link crafting/settings.md %}#recipe-visibility) for the other modes.
