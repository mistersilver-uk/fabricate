...
See [Crafting Checks]({% link checks/crafting.md %}) for how checks work.

---

## See Also

- [Routed Modes]({% link crafting/recipes/routed.md %}): produce different results from one recipe, chosen by ingredients or a skill check.
- [Crafting Checks]({% link checks/crafting.md %}): how crafting checks are configured.
