...
See [Crafting Checks]({% link checks/crafting.md %}) for how checks work and what they report.
...
See [Complications]({% link components/complications.md %}) for how to author one.
...
See [Salvaging From the Inventory Tab]({% link components/salvage.md %}#salvaging-from-the-inventory-tab).
...
- [Multi-Step Recipes]({% link crafting/recipes/multi-step.md %}): combine multiple steps into a single recipe workflow.
- [Crafting Checks]({% link checks/crafting.md %}): configure the progressive check roll formula.
- [Recipes overview]({% link crafting/recipes/index.md %}): compare all resolution modes side by side.
- [Complications]({% link components/complications.md %}): author what goes wrong when a stage is produced.
