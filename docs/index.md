...
GM's can create as many independent crafting systems as they like, with their own recipes, ingredients, tools, essences, gathering environments, tasks, and events.
...
GMs author single or multi-step recipes in the Crafting Admin panel across the overview, ingredients, results, tools, access, knowledge, and validation tabs.
...
| **Salvage**                | Players break components down into their contituent parts                                                                                                    |
