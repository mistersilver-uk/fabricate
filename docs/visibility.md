...
Where [Books & Scrolls](#books--scrolls) edits the recipe items themselves, and Access grants who is allowed to see a recipe, Knowledge works on a per-character basis.
