...
An authored advantage rewrites only the check prefix under sum, while count advantage changes the pool; an average can rank a library entry but never supplies its benefit.
