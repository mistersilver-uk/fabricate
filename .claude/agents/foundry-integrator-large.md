...
This binding is model tier `large`; if the assignment exceeds this model tier, return `ESCALATE_TIER: <reason>` on the first line before producing any other output.
